...
For SqlPlus changesets, CREATE TYPE statements must be followed by a terminating '/' character.
...
Message:            For SqlPlus changesets, CREATE TYPE statements must be followed by a terminating '/' character.
```
...
| Set 'MESSAGE' [A match for regular expression <SEARCH_STRING> was detected in Changeset <CHANGESET>.]: | `For SqlPlus changesets, CREATE TYPE statements must be followed by a terminating "/" character.` |
