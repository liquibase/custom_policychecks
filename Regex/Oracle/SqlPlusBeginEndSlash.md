...
For SqlPlus changesets, BEGIN and END; statements must be following by a terminating '/' character.
...
Message:            For SqlPlus changesets, BEGIN and END; statements must be following by a terminating "/" character.
```
...
| Set 'MESSAGE' [A match for regular expression <SEARCH_STRING> was detected in Changeset <CHANGESET>.]: | `For SqlPlus changesets, BEGIN and END; statements must be following by a terminating "/" character.` |
